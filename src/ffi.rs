...
pub type NLFn = extern fn(c_uint, *const c_double, Option<*mut c_double>, *mut c_void) -> c_double;
pub type NLMultiFn = extern fn(c_uint, result: *mut c_double, c_uint, Option<*const c_double>, *mut c_double, *mut c_void);

#[link(name = "nlopt")]
#[link(name = "m")]
extern "C" {
   pub fn nlopt_create(algorithm: c_uint, num_vars: c_uint) -> ProbInst;
   pub fn nlopt_destroy(prob: *mut ProbInst);

   pub fn nlopt_set_min_objective(prob: *mut ProbInst, obj: NLFn, data: *mut c_void) -> NLOptResult;
   pub fn nlopt_set_max_objective(prob: *mut ProbInst, obj: NLFn, data: *mut c_void) -> NLOptResult;
   ...
   pub fn nlopt_add_inequality_constraint(prob: *mut ProbInst, fc: NLFn, data: *mut c_void, tol: c_double) -> NLOptResult;
   pub fn nlopt_add_equality_constraint(prob: *mut ProbInst, fc: NLFn, data: *mut c_void, tol: c_double) -> NLOptResult;

   pub fn nlopt_add_inequality_mconstraint(prob: *mut ProbInst, fc: NLMultiFn, data: *mut c_void, tol: *const c_double) -> NLOptResult;
   pub fn nlopt_add_equality_mconstraint(prob: *mut ProbInst, fc: NLMultiFn, data: *mut c_void, tol: *const c_double) -> NLOptResult;
   ...
   pub fn nlopt_optimize(prob: *mut ProbInst, x: *const c_double, opt: *const c_double);
}
